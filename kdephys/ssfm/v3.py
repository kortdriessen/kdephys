...
def ssfm_v3(spg, emg_spg, nrem_percentiles=[50, 60, 65, 70], rem_percentiles=[60, 70, 80, 85], chan=2, ss=8, user_hyp=None, art=False):
    """
    ...
    emg_spg --> spectrogram of emg, Must have only one channel 
    ...
    emg_bands = kd.get_bp_set2(emg_spg, bands=bp_def, pandas=False)
    emg = emg_bands.omega
    ...
    hist, pc_ax = ssu.threshplot(pc, time=spg.datetime.values, percentiles=nrem_percentiles)
